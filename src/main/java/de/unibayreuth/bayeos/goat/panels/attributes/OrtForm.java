...
public class OrtForm extends JPanel {
    ...
    public void setEditable(boolean enabled){
      ...
      textFieldZ.setEditable(enabled);
      cboCRS.setEditable(enabled);      
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cboCRS = new javax.swing.JComboBox();
        ...
        labelX.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelX.setText("X:");
        ...
        add(labelX, gridBagConstraints);

        labelY.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelY.setText("Y:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 10, 1, 5);
        add(labelY, gridBagConstraints);
        
        labelCRC.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelCRC.setText("CRS:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 10, 1, 5);
        add(labelCRC, gridBagConstraints);
        
        
        cboCRS.setPreferredSize(new java.awt.Dimension(50, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 2.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 0);
        add(textFieldZ, gridBagConstraints);

        labelZ.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelZ.setText("Z:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        ...
        gridBagConstraints.weightx = 2.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 0);
        add(textFieldX, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 2.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 0);
        add(textFieldY, gridBagConstraints);
    ...
    public Double getXValue() throws NumberFormatException {
        if (textFieldX.getText().length() > 0) {
          return (Double.valueOf(textFieldX.getText()));
        } else { 
          return null;
        }
    }
    ...
    public void setXValue(Double X) {
        if (X != null) {
         this.textFieldX.setText(String.valueOf(X));
        } else {
          textFieldX.setText(null);
        }
    }
    
   public Double getYValue() throws NumberFormatException {
        if (textFieldY.getText().length() > 0) {
          return (Double.valueOf(textFieldY.getText()));
        } else { 
          return null;
        }
    }
    ...
    public void setYValue(Double Y) {
        if (Y != null) {
         this.textFieldY.setText(String.valueOf(Y));
        }else {
          textFieldY.setText(null);
        }
    }
    
    public Double getZValue() throws NumberFormatException {
        if (textFieldZ.getText().length() > 0) {
          return (Double.valueOf(textFieldZ.getText()));
        } else { 
          return null;
        }
    }
    ...
    public void setZValue(Double Z) {
        if (Z != null) {
         this.textFieldZ.setText(String.valueOf(Z));
        }else {
          textFieldZ.setText(null);
        }
    }
    
    public void setCRSId(Integer id){
    	cboCRS.setSelectedIndex(crsIndex.indexOf(id));
    }
    
    public Integer getCRSId(){ 
    	 int i = cboCRS.getSelectedIndex();
    	 if (i == -1){
    		 return null;
    	 } else {
    		return (Integer)crsIndex.get(i);
    	 }
    }
    ...
    private javax.swing.JComboBox  cboCRS;
