...
public abstract class AbstractTreeTransferHandler implements DragGestureListener, DragSourceListener, DropTargetListener {
 ...
 private boolean drawImage;
      ...
      protected AbstractTreeTransferHandler(JObjektTree tree, int action, boolean drawIcon) {
          this.tree = tree;
          drawImage = drawIcon;
   ...
   public final void dragGestureRecognized(DragGestureEvent dge) {
    ...
    public final void dragEnter(DropTargetDragEvent dtde) {
       ...
       public abstract boolean canPerformAction(JObjektTree target, DefaultMutableTreeNode draggedNode, int action, Point location);

       public abstract boolean executeDrop(JObjektTree tree, DefaultMutableTreeNode draggedNode, DefaultMutableTreeNode newParentNode, int action);
}
