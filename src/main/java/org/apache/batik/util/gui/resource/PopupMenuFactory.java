...
/**
 * This class represents a popupmenu factory which builds
 * popups from the content of a resource file.<br>
 *
 ...
 * @version $Id: PopupMenuFactory.java,v 1.1 2006/05/16 14:55:33 oliver Exp $
 */



public class PopupMenuFactory extends ResourceManager {
     ...
     */
    public PopupMenuFactory(ResourceBundle rb, ActionMap am) {
        super(rb);
        actions = am;
	buttonGroup = null;
    ...
    /**
     * Creates and returns a swing popup menu
     * @param name the name of the popup menu in the resource bundle
     ...
     *         action map
     */
    public JPopupMenu createJPopupMenu(String name)
	throws MissingResourceException,
        ...
        while (it.hasNext()) {
            result.add(createJPopupMenuComponent((String)it.next()));
        }
        return result;
    }
     ...
     *         action map
     */
    protected JComponent createJPopupMenuComponent(String name)
	throws MissingResourceException,
	       ResourceFormatException,
	       MissingListenerException {
	...
	try {
        ...
        // Command String
        try {
            item.setActionCommand(getString(name+COMMAND_SUFFIX));
        } catch (MissingResourceException e) {
        }
